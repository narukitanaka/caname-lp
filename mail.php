...
$require = array('お問い合わせ内容','会社名','お名前','メールアドレス');
...
if(($confirmDsp == 0 || $sendmail == 1) && $empty_flag != 1){
  ...
  if($responseKeys["success"] && $responseKeys["score"] >= 0.5) {
      ...
      header("Location: https://gh-check.com/caname-lp/thanks.html?success=1&score=" . $responseKeys["score"]);
      exit;
  } else {
